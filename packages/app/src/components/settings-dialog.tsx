...
export function SettingsDialog({ open, onClose }: SettingsDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative flex w-[640px] h-[400px] bg-background border rounded-2xl shadow-xl overflow-hidden">
        {/* Left Menu (30%) */}
        <div className="w-[30%] border-r bg-muted/30 p-4">
        ...
        {/* Right Content (70%) */}
        <div className="w-[70%] p-6 flex flex-col gap-4 overflow-auto">
          <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  <div className="w-full h-14 bg-white border rounded-md p-1.5 flex flex-col gap-1 shadow-sm">
                    ...
                    <div className="h-4 bg-blue-100 rounded w-full mt-auto flex items-center justify-center text-[8px] text-blue-600">Button</div>
                  </div>
                ...
                >
                  <div className="w-full h-14 bg-slate-950 border border-slate-800 rounded-md p-1.5 flex flex-col gap-1 shadow-sm">
                    ...
                    <div className="h-4 bg-slate-800 rounded w-full mt-auto flex items-center justify-center text-[8px] text-slate-400">Button</div>
                  </div>
                ...
                >
                  <div className="w-full h-14 bg-gradient-to-br from-white to-slate-950 border rounded-md p-1.5 flex flex-col gap-1 shadow-sm overflow-hidden relative">
                    ...
                    <div className="h-4 bg-gray-500/20 rounded w-full mt-auto flex items-center justify-center text-[8px] text-white/70 z-10">Button</div>
                  </div>
